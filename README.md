...
Please refer to the [Author Guide](gfm/author_guide.md) for further information.
...
The [Author Guide](gfm/author_guide.md) describes how to write source files.
...
1. [GtkBuilder and UI Files](gfm/sec9.md)
