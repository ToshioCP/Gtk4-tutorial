...
@@@else
![Screenshot of the label](/images/screenshot_lb1.png)
@@@end
...
@@@else
![Screenshot of the label](/images/screenshot_lb2.png)
@@@end
...
@@@else
![Parent-child relationship](/images/box.png)
@@@end
...
@@@else
![Screenshot of the box](/images/screenshot_lb4.png)
@@@end
