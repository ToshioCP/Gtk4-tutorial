...
There's the same file at [/src/misc/pr1.c](../src/misc/pr1.c) in your local repository.
All the example codes are under the [/src](../src/) directory as well.
...
![GtkWindow and GtkWidget](/src/images/window_widget.png)
...
![Screenshot of the window](/src/images/screenshot_pr3.png)
...
![Screenshot of the window](/src/images/screenshot_pr4.png)
